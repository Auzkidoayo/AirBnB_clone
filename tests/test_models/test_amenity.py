...
class TestAmenity(unittest.TestCase):
    ...
    def test_str(self):
        self.amenity1.name = "Jollof rice"
        expected = "[{}] ({}) {}".format(
    ...
    def test_name(self):
        ...
        Amenity.name = "Jollof rice"
        self.assertEqual(Amenity.name, "Jollof rice")
        self.assertEqual(self.amenity1.name, "Jollof rice")
        self.amenity1.name = "Hot Tub"
        self.assertEqual(self.amenity1.name, "Hot Tub")
        Amenity.name = "Firepalace"
        self.assertEqual(self.amenity2.name, "Firepalace")


    def test_to_dict(self):
        self.amenity1.name = "Firepalace"
    ...
    def test_init_with_kwargs(self):
        ...
        self.assertEqual(my_new_amenity.name, "Jollof rice")
